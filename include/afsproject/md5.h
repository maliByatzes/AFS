...
private:
  ...
  static constexpr uint32_t F(uint32_t, uint32_t, uint32_t);
  static constexpr uint32_t G(uint32_t, uint32_t, uint32_t);
  static constexpr uint32_t H(uint32_t, uint32_t, uint32_t);
  static constexpr uint32_t I(uint32_t, uint32_t, uint32_t);
  static constexpr uint32_t rotate_left(uint32_t, uint32_t);

  void init();
  void step(const std::array<uint32_t, 16> &);

  uint64_t m_size;
  std::array<uint32_t, 4> m_buffer;
  std::array<uint8_t, 64> m_input;
};
