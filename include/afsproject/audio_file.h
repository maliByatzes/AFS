...
public:
  ...
  virtual void setPCMData(const std::vector<double> &pcm_data, uint32_t sample_rate, uint16_t num_channels)// NOLINT
  {
    m_pcm_data = pcm_data;
  ...
  [[nodiscard]] virtual uint16_t getNumChannels() const = 0;
